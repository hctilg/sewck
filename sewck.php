...
if ($operation == 1) {
    ...
    $cipher_text = openssl_encrypt($plain_text, 'aes-256-cbc', md5($key), OPENSSL_RAW_DATA, $iv);
    ...
    $plain_text = openssl_decrypt($cipher_text, 'aes-256-cbc', md5($key), OPENSSL_RAW_DATA, $iv);
